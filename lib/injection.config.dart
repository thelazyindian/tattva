...
import 'application/audio/audio_bloc.dart' as _i12;
import 'application/authentication/authentication_bloc.dart' as _i13;
import 'domain/audio/i_audio_facade.dart' as _i8;
import 'domain/authentication/i_auth_facade.dart' as _i10;
import 'infrastructure/audio/audio_facade.dart' as _i9;
import 'infrastructure/authentication/auth_facade.dart' as _i11;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i8.IAudioFacade>(
      () => _i9.AudioFacade(get<_i6.FirebaseFunctions>()));
  ...
  gh.lazySingleton<_i12.AudioBloc>(
      () => _i12.AudioBloc(get<_i8.IAudioFacade>()));
  gh.lazySingleton<_i13.AuthenticationBloc>(
      () => _i13.AuthenticationBloc(get<_i10.IAuthFacade>()));
  return get;
}
