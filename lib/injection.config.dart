...
import 'application/audio/audio_bloc.dart' as _i21;
import 'application/audio_player/audio_player_bloc.dart' as _i3;
import 'application/authentication/authentication_bloc.dart' as _i22;
import 'application/blog/blog_bloc.dart' as _i23;
import 'application/liked_items/liked_items_bloc.dart' as _i19;
import 'application/wallpaper/wallpaper_bloc.dart' as _i20;
...
import 'domain/wallpaper/i_wallpaper_facade.dart' as _i17;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i17.IWallpaperFacade>(
      () => _i18.WallpaperFacade(get<_i4.Dio>()));
  gh.lazySingleton<_i19.LikedItemsBloc>(
      () => _i19.LikedItemsBloc(get<_i15.ILikedItemsFacade>()));
  gh.lazySingleton<_i20.WallpaperBloc>(
      () => _i20.WallpaperBloc(get<_i17.IWallpaperFacade>()));
  gh.lazySingleton<_i21.AudioBloc>(
      () => _i21.AudioBloc(get<_i9.IAudioFacade>()));
  gh.lazySingleton<_i22.AuthenticationBloc>(
      () => _i22.AuthenticationBloc(get<_i11.IAuthFacade>()));
  gh.lazySingleton<_i23.BlogBloc>(() => _i23.BlogBloc(get<_i13.IBlogFacade>()));
  return get;
}
